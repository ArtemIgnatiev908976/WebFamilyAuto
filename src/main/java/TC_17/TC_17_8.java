...
public class TC_17_8 {
    WebDriver driver;
    public TC_17_8(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public TC_17_8  typeNeverVisit() {
        driver.findElement(neverVisit).click();
        return this;
    }


    public TC_17_8  typePushNotVisitModal() {
        driver.findElement(pushNotVisitModal).click();
        return this;
    }


    public TC_17_8 typeAllDopGroups() {
    ...
    public TC_17_8 typeBlockByDopGroups() {
    ...
    public TC_17_8  typeSettingsDopGroups() {
