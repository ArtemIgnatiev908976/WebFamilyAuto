...
public class TC_17_4 {
    WebDriver driver;
    public TC_17_4(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public TC_17_4  typePushNoCorrectSheduleModal() {
        driver.findElement(pushNoCorrectSheduleModal).click();
        return this;
    }


    public TC_17_4  typeNoCorrectShedule() {
        driver.findElement(noCorrectShedule).click();
        return this;
    }

    public TC_17_4 typeAllDopGroups() {
    ...
    public TC_17_4 typeBlockByDopGroups() {
    ...
    public TC_17_4  typeSettingsDopGroups() {
