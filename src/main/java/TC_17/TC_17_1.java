...
public class TC_17_1 {
    WebDriver driver;
    public TC_17_1(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public TC_17_1  typeLowerGroup() {
        driver.findElement(lowerGroup).click();
        return this;
    }


    public TC_17_1  typeShowGroupsModal() {
        driver.findElement(showGroupsModal).click();
        return this;
    }
    public TC_17_1  typeShowGroup() {
        driver.findElement(showGroup).click();
        return this;
    }

    public TC_17_1  typeShowHideSettings() {
        driver.findElement(showHideSettings).click();
        return this;
    }

    public TC_17_1  typeSettingsButton() {
        driver.findElement(settingsButton).click();
        return this;
    }

    public TC_17_1 typeAllDopGroups() {
    ...
    public TC_17_1  typeSettingsDopGroups() {
        driver.findElement(settingsDopGroups).click();
        return this;
    }

    //Проверка на прозрачность
    public TC_17_1 typeGreyOpacity() {
