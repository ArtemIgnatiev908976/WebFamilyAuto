...
public class TC_17_6 {
    WebDriver driver;
    public TC_17_6(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public TC_17_6  typeNotVisit() {
        driver.findElement(notVisit).click();
        return this;
    }

    public TC_17_6  typePushNotVisitModal() {
        driver.findElement(pushNotVisitModal).click();
        return this;
    }

    public TC_17_6 typeAllDopGroups() {
    ...
    public TC_17_6 typeBlockByDopGroups() {
    ...
    public TC_17_6  typeSettingsDopGroups() {
