...
public class TC_2_4 {
    ...
    public TC_2_4(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public TC_2_4 typeLessonNameInTopic() {
    ...
    public TC_2_4 typeOpenTopic() {
        driver.findElement(openTopic).click();
        return this;
    }


    public TC_2_4 typeHoursOfTopic() {
    ...
    public TC_2_4 typeCardOfProgramm() {
        driver.findElement(cardOfProgramm).click();
        return this;
    }

    public TC_2_4 typeTimeOfWeek() {
    ...
    public TC_2_4 typeTimeOfProgramm() {
    ...
    public TC_2_4 typeObjectOfLearn() {
    ...
    public TC_2_4 typeParallelOfLearn() {
    ...
    public TC_2_4 typeLevelOfStudy() {
    ...
    public TC_2_4 typeNapravlennost() {
