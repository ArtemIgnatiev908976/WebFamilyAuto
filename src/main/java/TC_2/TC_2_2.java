...
public class TC_2_2 {
    ...
    public TC_2_2(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public TC_2_2 typeTimeOfProgramm() {
    ...
    public TC_2_2 typeObjectOfLearn() {
    ...
    public TC_2_2 typeParallelOfLearn() {
    ...
    public TC_2_2 typeLevelOfStudy() {
    ...
    public TC_2_2 typeNapravlennost() {
