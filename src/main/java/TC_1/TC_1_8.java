...
public class TC_1_8 {
    WebDriver driver;
    public TC_1_8(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public TC_1_8  typeFridayButton() {
    ...
    public TC_1_8 typeShedule7Days() {
    ...
    public TC_1_8 typeLessonAbsence() {
    ...
    public TC_1_8 typeСardOfFirstLessonNumber() {
    ...
    public TC_1_8 typeСardOfFirstLessonTime() {
    ...
    public TC_1_8 typeLessonIconTypeDOP() {
    ...
    public TC_1_8 typeLessonIconTypeDist() {
    ...
    public TC_1_8 typeCalendarSelector() {
        driver.findElement(calendarSelector).click();
        return this;
    }
    public TC_1_8  typeCalendarSelectorArrow() {
    ...
    public TC_1_8  typeMondaySelector() {
