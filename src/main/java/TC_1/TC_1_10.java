...
public class TC_1_10 {
    WebDriver driver;
    public TC_1_10(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public TC_1_10  typeFridayButton() {
    ...
    public TC_1_10 typeShedule7Days() {
    ...
    public TC_1_10 typeLessonAbsence() {
    ...
    public TC_1_10 typeСardOfFirstLessonNumber() {
    ...
    public TC_1_10 typeСardOfFirstLessonTime() {
    ...
    public TC_1_10 typeLessonIconTypeDOP() {
    ...
    public TC_1_10 typeLessonIconTypeDist() {
    ...
    public TC_1_10 typeCalendarSelector() {
        driver.findElement(calendarSelector).click();
        return this;
    }
    public TC_1_10  typeCalendarSelectorArrow() {
    ...
    public TC_1_10  typeMondaySelector() {
