...
public class TC_1_13 {
    WebDriver driver;
    public TC_1_13(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public TC_1_13  typeFridayButton() {
    ...
    public TC_1_13 typeShedule7Days() {
    ...
    public TC_1_13 typeLessonAbsence() {
    ...
    public TC_1_13 typeСardOfFirstLessonNumber() {
    ...
    public TC_1_13 typeСardOfFirstLessonTime() {
    ...
    public TC_1_13 typeLessonIconTypeDOP() {
    ...
    public TC_1_13 typeLessonIconTypeDist() {
    ...
    public TC_1_13 typeCalendarSelector() {
        driver.findElement(calendarSelector).click();
        return this;
    }
    public TC_1_13  typeCalendarSelectorArrow() {
    ...
    public TC_1_13  typeWeekSelector() {
