...
public class TC_1_5 {
    WebDriver driver;
    public TC_1_5(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public TC_1_5 typeShedule7Days() {
    ...
    public TC_1_5 typeLessonAbsence() {
    ...
    public TC_1_5 typeСardOfFirstLessonNumber() {
    ...
    public TC_1_5 typeСardOfFirstLessonTime() {
    ...
    public TC_1_5 typeLessonIconTypeDOP() {
    ...
    public TC_1_5 typeLessonIconTypeDist() {
    ...
    public TC_1_5 typeCalendarSelector() {
        driver.findElement(calendarSelector).click();
        return this;
    }
    public TC_1_5  typeCalendarSelectorArrow() {
    ...
    public TC_1_5  typeMondaySelector() {
