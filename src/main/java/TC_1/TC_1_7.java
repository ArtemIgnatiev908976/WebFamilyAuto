...
public class TC_1_7 {
    WebDriver driver;
    public TC_1_7(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public TC_1_7  typeFridayButton() {
    ...
    public TC_1_7 typeShedule7Days() {
    ...
    public TC_1_7 typeLessonAbsence() {
    ...
    public TC_1_7 typeСardOfFirstLessonNumber() {
    ...
    public TC_1_7 typeСardOfFirstLessonTime() {
    ...
    public TC_1_7 typeLessonIconTypeDOP() {
    ...
    public TC_1_7 typeLessonIconTypeDist() {
    ...
    public TC_1_7 typeCalendarSelector() {
        driver.findElement(calendarSelector).click();
        return this;
    }
    public TC_1_7  typeCalendarSelectorArrow() {
    ...
    public TC_1_7  typeMondaySelector() {
