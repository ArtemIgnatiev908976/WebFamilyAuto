...
public class TC_1_11 {
    WebDriver driver;
    public TC_1_11(WebDriver driver) {
        this.driver = driver;
    }
    ...
    //Отсутствие
    By Absence = By.xpath("//*[@id=\"root\"]/div[2]/main/div/div/div/div/div[2]/div/div[1]/div/div/div[1]/div/div[3]");
    //Б
    By B = By.xpath("//*[@id=\"root\"]/div[2]/main/div/div/div/div/div[2]/div/div[1]/div/div/div[1]/div/div[3]/div[4]");
    //H
    By H = By.xpath("//*[@id=\"root\"]/div[2]/main/div/div/div/div/div[2]/div/div[1]/div/div/div[1]/div/div[3]/div[3]");

    public TC_1_11 typeH() {
    ...
    public TC_1_11  typeFridayButton() {
    ...
    public TC_1_11 typeShedule7Days() {
    ...
    public TC_1_11 typeLessonAbsence() {
    ...
    public TC_1_11 typeСardOfFirstLessonNumber() {
    ...
    public TC_1_11 typeСardOfFirstLessonTime() {
    ...
    public TC_1_11 typeLessonIconTypeDOP() {
    ...
    public TC_1_11 typeLessonIconTypeDist() {
    ...
    public TC_1_11 typeCalendarSelector() {
        driver.findElement(calendarSelector).click();
        return this;
    }
    public TC_1_11  typeCalendarSelectorArrow() {
    ...
    public TC_1_11  typeMondaySelector() {
