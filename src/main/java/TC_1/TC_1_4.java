...
public class TC_1_4 {
    WebDriver driver;
    public TC_1_4(WebDriver driver) {
        this.driver = driver;
    }
    ...
    // Расписание 1 день
    By OneDay = By.xpath("/html/body/div[2]/div/div/div[1]/div/button[1]");

    public TC_1_4  typeOneDay() {
        driver.findElement(OneDay).click();
        return this;
    }

    public TC_1_4 typeShedule7Days() {
    ...
    public TC_1_4 typeLessonAbsence() {
    ...
    public TC_1_4 typeСardOfFirstLessonNumber() {
    ...
    public TC_1_4 typeСardOfFirstLessonTime() {
    ...
    public TC_1_4 typeLessonIconTypeDOP() {
    ...
    public TC_1_4 typeLessonIconTypeDist() {
    ...
    public TC_1_4 typeCalendarSelector() {
        driver.findElement(calendarSelector).click();
        return this;
    }
    public TC_1_4  typeCalendarSelectorArrow() {
    ...
    public TC_1_4  typeMondaySelector() {
