...
public class TC_1_3 {
    WebDriver driver;
    public TC_1_3(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public TC_1_3 typeShedule7Days() {
    ...
    public TC_1_3 typeLessonAbsence() {
    ...
    public TC_1_3 typeСardOfFirstLessonNumber() {
    ...
    public TC_1_3 typeСardOfFirstLessonTime() {
    ...
    public TC_1_3 typeLessonIconTypeDOP() {
    ...
    public TC_1_3 typeLessonIconTypeDist() {
    ...
    public TC_1_3 typeCalendarSelector() {
        driver.findElement(calendarSelector).click();
        return this;
    }
    public TC_1_3  typeCalendarSelectorArrow() {
    ...
    public TC_1_3  typeMondaySelector() {
