...
public class TC_1_9 {
    WebDriver driver;
    public TC_1_9(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public TC_1_9  typeFridayButton() {
    ...
    public TC_1_9 typeShedule7Days() {
    ...
    public TC_1_9 typeLessonAbsence() {
    ...
    public TC_1_9 typeСardOfFirstLessonNumber() {
    ...
    public TC_1_9 typeСardOfFirstLessonTime() {
    ...
    public TC_1_9 typeLessonIconTypeDOP() {
    ...
    public TC_1_9 typeLessonIconTypeDist() {
    ...
    public TC_1_9 typeCalendarSelector() {
        driver.findElement(calendarSelector).click();
        return this;
    }
    public TC_1_9  typeCalendarSelectorArrow() {
    ...
    public TC_1_9  typeMondaySelector() {
