...
public class TC_1_12 {
    WebDriver driver;
    public TC_1_12(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public TC_1_12  typeFridayButton() {
    ...
    public TC_1_12 typeShedule7Days() {
    ...
    public TC_1_12 typeLessonAbsence() {
    ...
    public TC_1_12 typeСardOfFirstLessonNumber() {
    ...
    public TC_1_12 typeСardOfFirstLessonTime() {
    ...
    public TC_1_12 typeLessonIconTypeDOP() {
    ...
    public TC_1_12 typeLessonIconTypeDist() {
    ...
    public TC_1_12 typeCalendarSelector() {
        driver.findElement(calendarSelector).click();
        return this;
    }
    public TC_1_12  typeCalendarSelectorArrow() {
    ...
    public TC_1_12  typeWeekSelector() {
