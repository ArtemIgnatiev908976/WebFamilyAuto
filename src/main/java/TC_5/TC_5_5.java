...
public class TC_5_5 {
    ...
    public TC_5_5(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public TC_5_5 typeColorMarkYear() {
        //Оценки по периодам должны отображаться в светло - зеленых квадратах.
    ...
    public TC_5_5 typeCalendarSelectorArrow() {
