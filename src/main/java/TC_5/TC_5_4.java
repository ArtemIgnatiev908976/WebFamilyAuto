...
public class TC_5_4 {
    ...
    public TC_5_4(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public TC_5_4 typeFormControlInCard() {
    ...
    public TC_5_4 typeDateAndTimeMark() {
    ...
    public TC_5_4  typeClickMark() {
        driver.findElement(clickMark).click();
        return this;
    }
    public TC_5_4 typeMarkLesson() {
    ...
    public TC_5_4 typeCalendarSelectorArrow() {
    ...
    public TC_5_4  typeDateMarks() {
        driver.findElement(dateMarks).click();
        return this;
    }

    public TC_5_4  typeLinkMarks() {
