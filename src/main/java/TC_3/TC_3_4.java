...
public class TC_3_4 {
    ...
    public TC_3_4(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public TC_3_4 typeDateAndTimeEvent() {
    ...
    public TC_3_4 typeBackEvent() {
        driver.findElement(backEvent).click();
        return this;
    }

    public TC_3_4 typeEvent() {
        driver.findElement(event).click();
        return this;
    }

    public TC_3_4 typeLinkEvent() {
